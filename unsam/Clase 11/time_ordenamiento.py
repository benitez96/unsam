...
tiempo_sel = experimento_timeit_seleccion(listas, 100)
tiempo_ins = experimento_timeit_insercion(listas, 100)
tiempo_bur = experimento_timeit_burbujeo(listas, 100)
tiempo_mer = experimento_timeit_merge(listas, 100)

x = np.linspace(1, 256, 256)

plt.plot(x, tiempo_sel)
plt.plot(x, tiempo_ins)
plt.plot(x, tiempo_bur)
plt.plot(x, tiempo_mer)

plt.title('Complejidad de Algoritmos')
plt.xlabel('Longitud de la lista')
plt.ylabel('Tiempo de ejecucion')
plt.legend(['Seleccion', 'Insercion', 'Burbujeo', 'Merge'])
